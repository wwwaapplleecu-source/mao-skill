...
| 语言 | 介绍 | 快速导�?|
|------|------|----------|
| **中文** | 毛泽东方法论AI助手 - 基于六层认知架构的智能分析系统，提供矛盾分析、实践指导、调查研究等6种核心方法，支持674个概念查询和四级渐进学习�?| [📦 安装](#安装与快速开�? �?[🚀 使用](#使用方法) �?[📚 学习](#学习系统) |
...
| **日本�?* | 毛沢東方法論AIアシスタント - 6層認知アーキテクチャに基づくインテリジェント分析システム。矛盾分析、実践理論、調査研究な�?つのコアメソッドを提供し�?74の概念クエリ�?段階の漸進的学習をサポートします�?| [📦 インストール](#インストールとクイックスター�? �?[🚀 使用方法](#使用方法) �?[📚 学習](#学習システム) |
| **한국�?* | 마오쩌둥 방법�?AI 어시스턴�?- 6계층 인지 아키텍처 기반 지능형 분석 시스�? 모순 분석, 실천 이론, 조사 연구 �?6가지 핵심 방법�?제공하며, 674�?개념 쿼리와 4단계 점진�?학습�?지원합니다. | [📦 설치](#설치-�?빠른-시작) �?[🚀 사용법](#사용-방법) �?[📚 학습](#학습-시스�? |
...
```mermaid
graph TB
    UI[用户界面�?br>命令解析/响应格式化] --> Analytics[分析决策�?br>智能推荐 78%+准确率]
    Analytics --> Methods[方法执行�?br>6种分析方法]
    Methods --> Knowledge[知识检索层<br>674概念�?四级学习]
    Knowledge --> Performance[性能监控�?br>实时监控/缓存优化]
    Performance --> Integration[集成接口�?br>统一接口/向后兼容]
...
| 功能 | 描述 | 命令示例 |
|------|------|----------|
| **智能分析** | 基于问题内容自动推荐最佳分析方法，支持矛盾、实践、调查、战略、群众、综�?种方�?| `/mao 分析团队协作问题` |
| **渐进学习** | 四级渐进学习路径：入�?15分钟)→基础(1小时)→进�?3小时)→专�?10小时) | `/mao learn --path=入门` |
| **概念查询** | 674个毛泽东核心概念库，支持概念查询和关系探�?| `/mao concepts 矛盾` |
| **方法比较** | 方法论比较分析，支持不同方法的对比和应用场景分析 | `/mao compare 矛盾�?实践论` |

</div>

---

> **📦 项目即Skill**: 整个`mao-colleague`项目就是一个完整的毛泽�?skill，安装后即可直接使用所有功能，无需单独复制子目录�?

## 📦 安装与快速开�?

<a id="installation--quick-start"></a>
<a id="インストールとクイックスター�?></a>
<a id="설치-�?빠른-시작"></a>
...
毛泽�?skill采用**主命�?子命�?*的统一架构，极大降低记忆负担：

```
/mao [问题]                     # 快捷方式：智能分�?
/mao help                      # 获取帮助（智能引导）
/mao analyze [问题]            # 智能分析（支�?-method参数�?
/mao learn                     # 学习系统（四级渐进路径）
/mao concepts                  # 概念查询系统�?74+概念�?
/mao compare                   # 方法比较系统
...
/mao analyze --method=矛盾 [问题] # 指定矛盾分析�?
/mao analyze --method=实践 [问题] # 指定实践论方�?
```

**支持的分析方�?*�?
- **矛盾分析�?*：识别主要矛盾和次要矛盾，分析矛盾转�?
- **实践论方�?*：遵�?实践-认识-再实�?循环，指导具体工�?
- **调查研究�?*：没有调查就没有发言权，典型与普遍结�?
- **战略思维�?*：持久战思维，战略藐视战术重�?
- **群众路线�?*：从群众中来，到群众中去
- **综合分析�?*：智能选择最适合的方法（默认�?
...
/mao learn 矛盾�?             # 学习"矛盾�?专题
/mao learn --path=入门         # 选择入门路径�?5分钟�?
/mao learn --path=基础         # 选择基础路径�?小时�?
/mao learn --path=进阶         # 选择进阶路径�?小时�?
/mao learn --path=专业         # 选择专业路径�?0小时�?
```

**四级渐进学习路径**�?
- **入门路径** (15分钟)：零基础快速掌握毛泽东方法论核�?
- **基础路径** (1小时)：系统学习毛泽东方法论体�?
- **进阶路径** (3小时)：深度应用毛泽东方法论解决复杂问�?
- **专业路径** (10小时)：理论研究和方法论创�?

#### 3. 概念查询
```bash
/mao concepts                  # 查看核心概念列表�?74+概念�?
/mao concepts 矛盾             # 查看"矛盾"概念详细解释
/mao concepts --search=群众     # 搜索包含"群众"的相关概�?
```
...
> 毛泽�?skill基于原始毛泽东著作构建，确保方法论的纯正性和准确性�?

| 著作类别 | 核心著作 | 方法论贡�?| 人格风格 | 应用场景 |
|----------|:--------:|:----------:|:--------:|----------|
| **哲学方法�?* | 《实践论�?| 实践-认识循环 | 实事求是 | 认识论指�?|
| **哲学方法�?* | 《矛盾论�?| 矛盾分析�?| 辩证思维 | 问题分析 |
| **军事战略** | 《论持久战�?| 持久战理�?| 战略定力 | 长期规划 |
| **综合选集** | 《毛泽东选集�?-4�?| 综合方法�?| 完整人格 | 全面指导 |
| **工作方法** | 《反对本本主义�?| 调查研究�?| 务实作风 | 调研指导 |
| **群众工作** | 《关心群众生活�?| 群众路线�?| 人民立场 | 群众工作 |
...
> **重要**：Claude Code �?**git 仓库根目�?* �?`.claude/skills/` 查找 skill。请在正确的位置执行�?
...
**推荐理由**: 问题中包�?矛盾"�?协作"�?问题"等关键词，适合使用矛盾分析法识别主要矛盾和次要矛盾�?
...
💡 **建议**: 如需深入学习矛盾分析法，请使�?`/mao learn 矛盾论`
```
...
1. **实践探索**：进行小范围产品设计实践，获取感性认�?
2. **总结提升**：总结经验，形成理性认识和改进方案
3. **指导实践**：用理性认识指导更大范围的设计实践
4. **循环验证**：实�?认识-再实践循环，逐步完善流程
...
毛泽�?skill基于**现代化六层认知架�?*设计，确保系统稳定性和扩展性：
...
### 核心组件
- **智能推荐�?*：基于问题内容推荐最佳分析方法（准确�?8%+�?
- **命令解析�?*：统一的主命令+子命令解析架�?
- **学习管理系统**：四级渐进学习路径和进度跟踪
- **概念查询系统**�?74个核心概念的关系网络查询

---

## 📁 项目结构

**📦 项目即Skill**：整个`mao-colleague`目录就是一个完整的毛泽�?skill
...
�?  ├── smart_recommender.py   # 智能推荐器（准确�?8%+�?
�?  ├── learning_system.py     # 学习管理系统（四级渐进路径）
�?  ├── mao_skill_integration_v2.py # 六层架构现代化接�?
�?  ├── analytics_layer.py     # 分析决策�?
�?  ├── method_executor.py     # 方法执行层（6种分析方法）
�?  ├── knowledge_retriever.py # 知识检索层�?74个概念）
...
├── data/                      # 📊 学习数据和概念库
├── docs/                      # 📖 使用文档
├── internal/                  # 🛠�?内部开发文件（用户不可见）
├── requirements.txt           # 🐍 Python依赖
└── LICENSE                    # ⚖️ MIT许可�?
```

> **🚀 完整安装使用**
现在整个`mao-colleague`项目就是一个完整的毛泽�?skill�?*请安装整个项�?*到你的技能目录�?

### 兼容性说�?
`colleagues/mao/`目录�?*向后兼容性文�?*，确保老用户继续可用。新用户无需单独复制此目录�?
...
### 使用建议
1. **命令简�?*：新版采用主命令+子命令架构，记忆负担降低41%
2. **智能推荐**：无需指定方法，系统会自动推荐最佳分析方�?
...
### Q4: 概念查询有什么用�?
**A**: 毛泽�?skill包含674个核心概念，�?矛盾"�?实践"�?群众路线"等。使用`/mao concepts [概念名]`可以查询概念的详细解释、相关概念和应用示例�?

---

## 🌍 多语言快速指�?| Multilingual Quick Guide

### 📦 安装与快速开�?| Installation & Quick Start
...
- **日本�?*: プロジェクト全体をSkillとしてインストー�? `git clone https://github.com/wwwaapplleecu-source/mao-skill [skill-directory]`
- **한국�?*: 전체 프로젝트�?Skill�?설치: `git clone https://github.com/wwwaapplleecu-source/mao-skill [skill-directory]`
...
- **日本�?*: インテリジェント分析には `/mao [質問]`、学習開始に�?`/mao learn` を使�?
- **한국�?*: 지능형 분석은 `/mao [질문]`, 학습 시작은 `/mao learn` 사용
...
- **日本�?*: 4段階漸進学�? 入門(15�?→基�?1時間)→応�?3時間)→専門(10時間)
- **한국�?*: 4단계 점진�?학습: 입문(15�?→기�?1시간)→고�?3시간)→전�?10시간)
...
| **日本�?* | [📦 インストール](#インストールとクイックスター�? | [🚀 使用](#使用方法-1) | [📚 学習](#学習システム) | [🔍 概念](#概念クエリシステ�? | [📘 詳細ガイド](../docs/language/ja/quick_start.md) |
| **한국�?* | [📦 설치](#설치-�?빠른-시작) | [🚀 사용](#사용-방법) | [📚 학습](#학습-시스�? | [🔍 개념](#개념-쿼리-시스�? | [📘 상세 가이드](../docs/language/ko/quick_start.md) |
...
- **[한국�?빠른 시작](../docs/language/ko/quick_start.md)** - 예제가 포함�?완전�?한국�?가이드
...
MIT License © [Abner](https://github.com/wwwaapplleecu-source) | 基于现代化AI技能架构构�?
