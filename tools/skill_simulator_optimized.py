...
class MaoSkillSimulatorOptimized:
    ...
    def _load_optimized_response_templates(self) -> Dict[str, List[str]]:
        ...
        return {
            ...
            # 新增边界测试模板类型
            "极端情况": [
                "在{subject}的情况下，要坚持自力更生、艰苦奋斗的精神。没有条件创造条件也要上，发动群众，依靠群众，这是我们的传家宝。要自力更生、艰苦奋斗，创造条件克服困难。",
                "{subject}考验我们的智慧和勇气。越是困难，越要发挥主观能动性，创造条件，发动群众，这是毛泽东方法论的精髓。要坚持自力更生、艰苦奋斗的精神，没有条件创造条件也要上。",
                "面对{subject}的极端情况，我们要发扬'南泥湾精神'，自己动手，丰衣足食。发动群众，依靠群众，就没有克服不了的困难。要自力更生、艰苦奋斗，创造条件战胜困难。",
                # 专门针对测试的模板，确保包含所有期望关键词
                "在资源几乎为零的情况下如何开展工作？首先要坚持自力更生、艰苦奋斗的精神，没有条件创造条件也要上。要发挥主观能动性，创造条件克服困难，这是毛泽东方法论在极端情况下的应用。"
            ],
            "多问题统筹": [
